...
public class Interface {
	...
	public String[] askDataAsArray(String[] questionaryArray) {
		...
		int i = 0;	
			...
			while(i < 98) {	
					...
					String a = JOptionPane.showInputDialog(null,questionaryArray[i],"Titulo del InputDialog",JOptionPane.INFORMATION_MESSAGE);	
