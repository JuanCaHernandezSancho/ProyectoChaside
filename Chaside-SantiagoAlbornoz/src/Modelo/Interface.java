...
public interface Interface {
	...
	String []interesesH= {"Precisión Verbal ","Organización","Relación de Hechos ","Lingüística"," Orden  ", "Justicia ","El hombre analítico  "};
	String []interesesA= {"Estético","Armónico ","Manual  ","Visual "," Auditivo  ", "observacion y analisis ","Senso-Perceptivo"};
	String []interesesS= {"Asistir ","Investigativo ","Precisión ","Senso-Perceptivo "," Analítico ", "Ayudar ","Curar  ","Rehabilitar "};
	String []interesesI= {"Cálculo ","Científico  ","Manual  ","Exacto "," Planificar  ", "Organizar  ","Controlar"};
	String []interesesD= {"Justicia  ","Equidad   ","Colaboración   ","Espíritu de Equipo  "," Liderazgo   ", "Coordinación   ","Destreza Física "};
	String []interesesE= {"Investigación ","Orden ","Organización","analisis y sintesis"," Numérico ", "Clasificar ","Precisión  ","Exacto "};
	String []aptitudC= {"Persuasivo ","Objetivo ","Práctico","Tolerante ","Responsable ","Ambicioso ","Dinámico ","Resolutivo "};
	String []aptitudH= {"Responsable","Justo","Conciliador","Persuasivo","Sagaz","Imaginativo","Comprensivo","Estabilidad Emocional"};
	String []aptitudA= {"Sensible","Imaginativo","Creativo ","Detallista","Innovador ","Intuitivo ","Paciente ","Espontáneo"};
	String []aptitudS= {"Altruista","Solidario","Paciente","Comprensivo","Respetuoso","Persuasivo","Servicial","Observador"};
	String []aptitudI= {"Preciso ","Práctico","Crítico ","Analítico ","Rígido ","Racional ","Independiente"};
	String []aptitudD= {"Arriesgado","Solidario","Valiente","Agresivo","Persuasivo","Aventurero","Equilibrio Psíquico"};
	String []aptitudE= {"Metódico","Analítico","Observador","Introvertido","Paciente","Seguro","Independiente","Intuitivo"};
	 String []preguntas= {"1 ¿Aceptaría trabajar escribiendo artículos en la sección económica de un diario? ",
			...
			"55 ¿Tenés interés por saber cuales son las causas que determinan ciertos fenómenos, aunque saberlo no altere tu vida?",
			...
			"62 ¿Acostumbras a leer revistas relacionadas con los últimos avance s científicos y tecnológicos en el área de la salud?" , 
			...
			"65 ¿Te gustaría realizar tareas auxiliares en una nave, como por ejemplo izado y\r\n arriado de velas, pintura y conservación del casco, arreglo de averías,conservación de motores, etc?" ,		
